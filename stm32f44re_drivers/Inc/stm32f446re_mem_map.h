...
#ifndef STM32F446RE_MEM_MAP_H_
#define STM32F446RE_MEM_MAP_H_
...
{
	__vo uint32 rcc_cr;
	__vo uint32 rcc_pllcfgr;
	__vo uint32 rcc_cfgr;
	__vo uint32 rcc_cir;
	__vo uint32 rcc_ahb1rstr;
	__vo uint32 rcc_ahb2rstr;
	__vo uint32 rcc_ahb3rstr;
	__vo uint32 rcc_reserved0;
	__vo uint32 rcc_apb1rstr;
	__vo uint32 rcc_apb2rstr;
	__vo uint32 rcc_reserved1[2];
	__vo uint32 rcc_ahb1enr;
	__vo uint32 rcc_ahb2enr;
	__vo uint32 rcc_ahb3enr;
	__vo uint32 rcc_reserved2;
	__vo uint32 rcc_apb1enr;
	__vo uint32 rcc_apb2enr;
	__vo uint32 rcc_reserved3[2];
	__vo uint32 rcc_ahb1lpenr;
	__vo uint32 rcc_ahb2lpenr;
	__vo uint32 rcc_ahb3lpenr;
	__vo uint32 rcc_reserved4;
	__vo uint32 rcc_apb1lpenr;
	__vo uint32 rcc_apb2lpenr;
	__vo uint32 rcc_reserved5[2];
	__vo uint32 rcc_bdcr;
	__vo uint32 rcc_csr;
	__vo uint32 rcc_reserved6[2];
	__vo uint32 rcc_sscgr;
	__vo uint32 rcc_plli2scfgr;
	__vo uint32 rcc_pllsaicfgr;
	__vo uint32 rcc_dckcfgr;
	__vo uint32 rcc_ckgatenr;
	__vo uint32 rcc_dckcfgr2;
} rcc_reg_set;
