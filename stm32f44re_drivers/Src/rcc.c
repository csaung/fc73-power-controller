...
#define RCC_CR_HSE_BYPASSED			(RCC_CR_HSION_ON|RCC_CR_HSEON_ON|RCC_CR_PLLON_ON|\
									RCC_CR_HSEBYP_ON)

#define RCC_CR_HSE_CRYSTAL			(RCC_CR_HSION_ON|RCC_CR_HSEON_ON|RCC_CR_PLLON_ON|\
									RCC_CR_HSEBYP_OFF)
...
#define RCC_PLLCFGR_PLLP			(0ul << 16u)			//divide by 2, getting 180MHz
...
void rcc_system_clk_config(enum rcc_extern_clk_src clk_src);
